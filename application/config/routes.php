...
$route['home'] = "NavigationController/home";
$route['faq'] = "NavigationController/FAQ";
$route['about'] = "NavigationController/about";
$route['contact'] = "NavigationController/contact";
$route['login'] = "NavigationController/login";

$route['register'] = "RegistrationController/register";
$route['registerBilling'] = "RegistrationController/registerBilling";
